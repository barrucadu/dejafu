...
|   | Version | Summary |
| - | ------- | ------- |
| [concurrency][h:conc]    | 1.2.1.1 | Typeclasses, functions, and data types for concurrency and STM. |
| [dejafu][h:dejafu]       | 0.8.0.0 | Systematic testing for Haskell concurrency. |
| [hunit-dejafu][h:hunit]  | 0.7.0.1 | Deja Fu support for the HUnit test framework. |
| [tasty-dejafu][h:tasty]  | 0.7.0.1 | Deja Fu support for the Tasty test framework. |
